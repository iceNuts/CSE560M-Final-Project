...
public class CacheStats {
    ...
    public void print() {
        System.out.format("-----HIT----- %d\n", total_hits);
        System.out.format("-----ACC----- %d\n", total_accesses);
        
		System.out.println(hit_rate);
    	System.out.format("Cache Hit Rate = %.2f%% (Mis-rate: %.2f%%)\n", 
			  hit_rate*100.0, (1-hit_rate)*100.0);
    	System.out.format("Total number of bytes tranferred write-back: %d\n", total_bytes_transferred_wb);
    	System.out.format("Total number of bytes tranferred write-thru: %d\n", total_bytes_transferred_wt);
    	
		System.out.println("write-thru:" + Double.toString(total_bytes_transferred_wt/(double)total_accesses));
		System.out.println("write-back:" + Double.toString(total_bytes_transferred_wb/(double)total_accesses));
